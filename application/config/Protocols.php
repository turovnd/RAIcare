...
(
    ...
    'P12' => array(
        ...
        '1' => array(
            'name' => 'Выявлено - необходимо вмешателсьво, у резидента пролежневая язва 2 степени',
            'key'  => 1,
            'class' => 'text-danger'
        ),
        '2' => array(
            'name' => 'Выявлено - необходимо вмешателсьво, у резидента пролежневая язва 1 степени',
            'key'  => 2,
            'class' => 'text-danger'
        ),
        '3' => array(
