                        ...
                        <div class="col-xs-12">
                            ...
                            <? if ($co_worker->is_confirmed == 0) : ?>
                                <div class="form-group__control-group hide">
                                    ...
                                    <label onclick="organization.coworker.toggle(this)" class="b-l-0 cursor-pointer form-group__control-group-addon"><i class="fa fa-times" aria-hidden="true"></i></label>
