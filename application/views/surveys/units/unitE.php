            ...
            <div class="block__body">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12">
                            <? if ($can_conduct) : ?>
                                <select name="E1[]" id="E1a" class="form-group__control">
                            ...
                            <? else : ?>
                                <p class="form-group__control-static p-l-0"> <?= !empty($survey->unitE->E1) ? $E1[$survey->unitE->E1[0]] : 'не указано'; ?> </p>
                            <? endif; ?>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-12">
                            <? if ($can_conduct) : ?>
                                <select name="E1[]" id="E1b" class="form-group__control">
                                    <option value="-1"></option>
                                    <? foreach ($E1 as $key => $option) :?>
                            ...
                            <? else : ?>
                                <p class="form-group__control-static p-l-0"> <?= !empty($survey->unitE->E1) ? $E1[$survey->unitE->E1[1]] : 'не указано'; ?> </p>
                            <? endif; ?>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-12">
                            <? if ($can_conduct) : ?>
                                <select name="E1[]" id="E1c" class="form-group__control">
                                    <option value="-1"></option>
                                    <? foreach ($E1 as $key => $option) :?>
                            ...
                            <? else : ?>
                                <p class="form-group__control-static p-l-0"> <?= !empty($survey->unitE->E1) ? $E1[$survey->unitE->E1[2]] : 'не указано'; ?> </p>
                            <? endif; ?>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-12">
                            <? if ($can_conduct) : ?>
                                <select name="E1[]" id="E1d" class="form-group__control">
                                    <option value="-1"></option>
                                    <? foreach ($E1 as $key => $option) :?>
                            ...
                            <? else : ?>
                                <p class="form-group__control-static p-l-0"> <?= !empty($survey->unitE->E1) ? $E1[$survey->unitE->E1[3]] : 'не указано'; ?> </p>
                            <? endif; ?>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-12">
                            <? if ($can_conduct) : ?>
                                <select name="E1[]" id="E1e" class="form-group__control">
                                    <option value="-1"></option>
                                    <? foreach ($E1 as $key => $option) :?>
                            ...
                            <? else : ?>
                                <p class="form-group__control-static p-l-0"> <?= !empty($survey->unitE->E1) ? $E1[$survey->unitE->E1[4]] : 'не указано'; ?> </p>
                            <? endif; ?>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-12">
                            <? if ($can_conduct) : ?>
                                <select name="E1[]" id="E1f" class="form-group__control">
                                    <option value="-1"></option>
                                    <? foreach ($E1 as $key => $option) :?>
                            ...
                            <? else : ?>
                                <p class="form-group__control-static p-l-0"> <?= !empty($survey->unitE->E1) ? $E1[$survey->unitE->E1[5]] : 'не указано'; ?> </p>
                            <? endif; ?>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-12">
                            <? if ($can_conduct) : ?>
                                <select name="E1[]" id="E1g" class="form-group__control">
                                    <option value="-1"></option>
                                    <? foreach ($E1 as $key => $option) :?>
                            ...
                            <? else : ?>
                                <p class="form-group__control-static p-l-0"> <?= !empty($survey->unitE->E1) ? $E1[$survey->unitE->E1[6]] : 'не указано'; ?> </p>
                            <? endif; ?>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-12">
                            <? if ($can_conduct) : ?>
                                <select name="E1[]" id="E1h" class="form-group__control">
                                    <option value="-1"></option>
                                    <? foreach ($E1 as $key => $option) :?>
                            ...
                            <? else : ?>
                                <p class="form-group__control-static p-l-0"> <?= !empty($survey->unitE->E1) ? $E1[$survey->unitE->E1[7]] : 'не указано'; ?> </p>
                            <? endif; ?>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-12">
                            <? if ($can_conduct) : ?>
                                <select name="E1[]" id="E1i" class="form-group__control">
                                    <option value="-1"></option>
                                    <? foreach ($E1 as $key => $option) :?>
                            ...
                            <? else : ?>
                                <p class="form-group__control-static p-l-0"> <?= !empty($survey->unitE->E1) ? $E1[$survey->unitE->E1[8]] : 'не указано'; ?> </p>
                            <? endif; ?>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-12">
                            <? if ($can_conduct) : ?>
                                <select name="E1[]" id="E1j" class="form-group__control">
                                    <option value="-1"></option>
                                    <? foreach ($E1 as $key => $option) :?>
                            ...
                            <? else : ?>
                                <p class="form-group__control-static p-l-0"> <?= !empty($survey->unitE->E1) ? $E1[$survey->unitE->E1[9]] : 'не указано'; ?> </p>
                            <? endif; ?>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-12">
                            <? if ($can_conduct) : ?>
                                <select name="E1[]" id="E1k" class="form-group__control">
                                    <option value="-1"></option>
                                    <? foreach ($E1 as $key => $option) :?>
                            ...
                            <? else : ?>
                                <p class="form-group__control-static p-l-0"> <?= !empty($survey->unitE->E1) ? $E1[$survey->unitE->E1[10]] : 'не указано'; ?> </p>
                            <? endif; ?>
                        </div>
                    </div>
                </fieldset>
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12">
                            <? if ($can_conduct) : ?>
                                <select name="E2[]" id="E2a" class="form-group__control">
                                    <option value="-1"></option>
                            ...
                            <? else : ?>
                                <p class="form-group__control-static p-l-0"> <?= !empty($survey->unitE->E2) ? $E2[$survey->unitE->E2[0]] : 'не указано'; ?> </p>
                            <? endif; ?>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-12">
                            <? if ($can_conduct) : ?>
                                <select name="E2[]" id="E2b" class="form-group__control">
                                    <option value="-1"></option>
                                    <? foreach ($E2 as $key => $option) :?>
                            ...
                            <? else : ?>
                                <p class="form-group__control-static p-l-0"> <?= !empty($survey->unitE->E2) ? $E2[$survey->unitE->E2[1]] : 'не указано'; ?> </p>
                            <? endif; ?>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-12">
                            <? if ($can_conduct) : ?>
                                <select name="E2[]" id="E2c" class="form-group__control">
                                    <option value="-1"></option>
                                    <? foreach ($E2 as $key => $option) :?>
                            ...
                            <? else : ?>
                                <p class="form-group__control-static p-l-0"> <?= !empty($survey->unitE->E2) ? $E2[$survey->unitE->E2[2]] : 'не указано'; ?> </p>
                            <? endif; ?>
                        </div>
                    </div>
                </fieldset>
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12">
                            <? if ($can_conduct) : ?>
                                <select name="E3[]" id="E3a" class="form-group__control">
                                    <option value="-1"></option>
                            ...
                            <? else : ?>
                                <p class="form-group__control-static p-l-0"> <?= !empty($survey->unitE->E3) ? $E3[$survey->unitE->E3[0]] : 'не указано'; ?> </p>
                            <? endif; ?>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-12">
                            <? if ($can_conduct) : ?>
                                <select name="E3[]" id="E3b" class="form-group__control">
                                    <option value="-1"></option>
                                    <? foreach ($E3 as $key => $option) :?>
                            ...
                            <? else : ?>
                                <p class="form-group__control-static p-l-0"> <?= !empty($survey->unitE->E3) ? $E3[$survey->unitE->E3[1]] : 'не указано'; ?> </p>
                            <? endif; ?>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-12">
                            <? if ($can_conduct) : ?>
                                <select name="E3[]" id="E3c" class="form-group__control">
                                    <option value="-1"></option>
                                    <? foreach ($E3 as $key => $option) :?>
                            ...
                            <? else : ?>
                                <p class="form-group__control-static p-l-0"> <?= !empty($survey->unitE->E3) ? $E3[$survey->unitE->E3[2]] : 'не указано'; ?> </p>
                            <? endif; ?>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-12">
                            <? if ($can_conduct) : ?>
                                <select name="E3[]" id="E3d" class="form-group__control">
                                    <option value="-1"></option>
                                    <? foreach ($E3 as $key => $option) :?>
                            ...
                            <? else : ?>
                                <p class="form-group__control-static p-l-0"> <?= !empty($survey->unitE->E3) ? $E3[$survey->unitE->E3[3]] : 'не указано'; ?> </p>
                            <? endif; ?>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-12">
                            <? if ($can_conduct) : ?>
                                <select name="E3[]" id="E3e" class="form-group__control">
                                    <option value="-1"></option>
                                    <? foreach ($E3 as $key => $option) :?>
                            ...
                            <? else : ?>
                                <p class="form-group__control-static p-l-0"> <?= !empty($survey->unitE->E3) ? $E3[$survey->unitE->E3[4]] : 'не указано'; ?> </p>
                            <? endif; ?>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-12">
                            <? if ($can_conduct) : ?>
                                <select name="E3[]" id="E3f" class="form-group__control">
                                    <option value="-1"></option>
                                    <? foreach ($E3 as $key => $option) :?>
                            ...
                            <? else : ?>
                                <p class="form-group__control-static p-l-0"> <?= !empty($survey->unitE->E3) ? $E3[$survey->unitE->E3[5]] : 'не указано'; ?> </p>
                            <? endif; ?>
                        </div>
                    </div>
