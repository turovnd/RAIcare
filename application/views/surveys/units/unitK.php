<?
$K3 = array(
    '0' => 'Обычный режим - пациент проглатывает пищу всех видов',
    '1' => 'Условно-независимый режим - например: пациент пьет жидкость мелкими глоточками или принимает ограниченные объемы твердой пищи; необходимость в модификации диеты может быть неизвестна',
    '2' => 'Для проглатывания твердой пищи требуется модификация диеты - например: требуется механическая модификация диеты (пища превращается в пюре или в фарш и т.д.) или пациент может принимать только определенные виды пищи.',
    '3' => 'Для проглатывания жидкостей требуется изменение консистенции пищи - например: сгущенные жидкости',
    '4' => 'Пациент может проглатывать твердую пищу только в виде пюре и сгущенные жидкости',
