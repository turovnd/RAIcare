            ...
            <div class="form__body">
                ...
                <fieldset>
                    <div class="form-group">
                        <label for="B1" class="form-group__label col-xs-12 f-s-1">
                            B1. Степень самостоятельности резидента при принятии решение о поступление в лечебное учреждение по уходу
                        </label>
                        <div class="col-xs-12">
                            <? if ($can_conduct) : ?>
                ...
                <fieldset>
                    <p class="col-xs-12 text-bold">
                        B5. Местоположение, из которого поступил резидент, и его постоянное место проживания
                    </p>
                ...
                <fieldset>
                    <div class="form-group">
                        <label for="B7" class="form-group__label col-xs-12 f-s-1">
                            B7. С кем проживал резидент до поступления в лечебное учреждение
                        </label>
                        <div class="col-xs-12">
                            <? if ($can_conduct) : ?>
                ...
                <fieldset>
                    <div class="form-group">
                        <label for="B8" class="form-group__label col-xs-12 f-s-1">
                            B8. История проживания резидента в учреждениях с коллективным проживание за последних 5 лет
                            <small class="text-italic text-normal">Отметьте все жилищные условия, в которых резидент жил за последние 5 ЛЕТ перед поступлением в лечебное учреждение</small>
                        </label>
                        <div class="col-xs-12">
                            <? if ($can_conduct) : ?>
