        ...
        <div class="form">
            ...
            <div class="form__body">
                ...
                <fieldset>
                    ...
                    <div class="col-xs-12">
                        <span class="text-bold">G1. Эффективность действий пациента в области повседневной деятельности</span>
                        <small>
                            <p class="text-italic">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        <label for="G2d" class="form-group__label col-xs-12">
                            d. Расстояние, которое пациент самостоятельно проезжал на инвалидной коляске
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        <label for="G3b" class="form-group__label col-xs-12">
                            b. Число дней ЗА ПОСЛЕДНИЕ 3 ДНЯ, когда пациент выходил из дома/здания, в котором он проживает
                ...
                <fieldset>
                    ...
                    <p class="col-xs-12 text-bold">
                        G4. Потенциал улучшения функционального состояния пациента
                    </p>

                    <div class="form-group">
                        <label for="G4a" class="form-group__label col-xs-12">
                            a. Пациент полагает, что он способен повысить эффективность своих физических функций
                        </label>
                        <div class="col-xs-12">
                            <? if ($can_conduct) : ?>
                    ...
                    <div class="form-group">
                        <label for="G4b" class="form-group__label col-xs-12">
                            b. Специалист в области ухода полагает, что пациент способен повысить эффективность своих физических функций
                        </label>
                        <div class="col-xs-12">
                            <? if ($can_conduct) : ?>
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        <label for="G5" class="form-group__label col-xs-12 f-s-1">
                            G5. Изменение эффективности действий пациента в области повседневной деятельности за последние 90 дней или со дня предыдущей оценки, если она проводилась менее 90 дней назад
                        </label>
                        <div class="col-xs-12">
                            <? if ($can_conduct) : ?>
