...
<h3 class="section__heading">
    <? if (!$can_conduct) : ?>
        <a role="button" onclick="raisoft.collapse.toggle(this)" data-area="unitO" data-opened="true" data-textclosed="показать" data-textopened="скрыть" class="btn btn--default btn--sm m-b-0 fl_r collapse-btn"></a>
    <? endif; ?>
...
<form class="row" id="unitO" onsubmit="event.preventDefault()">
    ...
    <div class="col-xs-12">
        ...
        <div class="form">
            ...
            <? if ($can_conduct) : ?>
                <a type="button" role="button" class="form__submit text-center text-brand text-bold" onclick="survey.send.updateunit('unitO');">
                    Сохранить
                </a>
            <? endif; ?>
