            ...
            <div class="form__body">
                ...
                <fieldset>
                    ...
                    <p class="col-xs-12 text-bold">
                        ...
                        пройденные резидентом за последние 3 дня (или со дня
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        <label for="O5" class="form-group__label col-xs-12 f-s-1">
                            ...
                            <small class="text-italic text-normal">
                                Число дней, когда резидента посещал терапевт, за ПОСЛЕДНИЕ 14 ДНЕЙ
                    ...
                    <div class="form-group">
                        <label for="O6" class="form-group__label col-xs-12 f-s-1">
                            ...
                            <small class="text-italic text-normal">
                                ...
                                резидента. Сюда также входят имеющий соответствующий допуск
