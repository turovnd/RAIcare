            ...
            <div class="form__body">
                ...
                <fieldset>
                    ...
                    <p class="col-xs-12 text-bold">
                        ...
                        <small class="text-italic text-normal">Примечание: При возможности задавайте вопросы резиденту, сотрудникам, осуществляющим непосредственный уход за резидентом, и членам его семьи.</small>
                    </p>
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        <label for="F3c" class="form-group__label col-xs-12">
                            c. Персонал сообщает о стойком чувстве стресса при взаимодействии с резидентом
                        </label>
                        <div class="col-xs-12">
                            <? if ($can_conduct) : ?>
                    ...
                    <div class="form-group">
                        <label for="F3d" class="form-group__label col-xs-12">
                            d. Члены семьи или близкие друзья сообщают, что они подавлены болезнью резидента
                        </label>
                        <div class="col-xs-12">
                            <? if ($can_conduct) : ?>
                    ...
                    <div class="form-group">
                        <label for="F3e" class="form-group__label col-xs-12">
                            e. Резидент говорит или показывает, что чувствует себя одиноко
                        </label>
                        <div class="col-xs-12">
                            <? if ($can_conduct) : ?>
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        <label for="F4" class="form-group__label col-xs-12 f-s-1">
                            ...
                            <small class="text-italic text-normal">Например: серьезная болезнь резидента, смерть или серьезная болезнь члена семьи или друга, потеря дома резидентом, значительная потеря дохода или активов, совершение в отношении резидента преступления (ограбления или нападения), потеря водительских прав или машины резидента.</small>
                        </label>
                        <div class="col-xs-12">
                            <? if ($can_conduct) : ?>
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        <label for="F5b" class="form-group__label col-xs-12">
                            b. Резидент видит смысл в своей повседневной жизни
                        </label>
                        <div class="col-xs-12">
                            <? if ($can_conduct) : ?>
