<?
$M1 = array(
    '1' => 'Пациент не участвовал в индивидуальной или групповой деятельности',
    '2' => 'Небольшое время участия — меньше 1/3 всего времени',
    '3' => 'Небольшое время участия — от 1/3 до 2/3 всего времени',
    '4' => 'Участие на протяжении большей части времени — более 2/3 всего времени'
);
$M2 = array(
    '1' => 'Не интересуется, не участвовал в течение последних 3 дней',
    '2' => 'Не интересуется, участвовал в течение последних 3 дней',
    '3' => 'Интересуется, не участвует',
    '4' => 'Интересуется, регулярно участвует, но не в последние 3 дня',
    '5' => 'Интересуется, участвовал в течение последних 3 дней'
);
$M3 = array(
    '0' => 'Пациент бодрствует весь день или большую часть дня (дремал не более одного раза утром или во второй половине дня)',
    '1' => 'Дремал неоднократно в течение дня',
    '2' => 'Пациент спал большую часть времени, но в отдельные периоды бодрствовал и находился в сознании (например, при приеме пищи)',
...
<h3 class="section__heading">
    <? if (!$can_conduct) : ?>
        <a role="button" onclick="raisoft.collapse.toggle(this)" data-area="unitM" data-opened="true" data-textclosed="показать" data-textopened="скрыть" class="btn btn--default btn--sm m-b-0 fl_r collapse-btn"></a>
    <? endif; ?>
    Досуг
</h3>
