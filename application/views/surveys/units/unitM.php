...
<form class="row" id="unitM" onsubmit="event.preventDefault()">
    ...
    <div class="col-xs-12">
        ...
        <div class="form">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        <label for="M1" class="form-group__label col-xs-12 f-s-1">
                            ...
                            <small class="text-italic text-normal">Например: самостоятельной или групповой. Примечание: когда резидент бодрствует и не
            ...
            <? if ($can_conduct) : ?>
                <button type="button" role="button" class="form__submit text-center text-bold link" onclick="survey.send.updateunit('unitM');">
                    Сохранить
                </button>
            <? endif; ?>
