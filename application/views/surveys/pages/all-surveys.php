    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            ...
            <form class="search" data-search="surveys">
                <input id="search" type="search" placeholder="Начните вводить ФИО пациента или название пансионата" class="search__input" oninput="survey.get.search(this)" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false">
                <label for="search" class="search__submit">
                    <i class="fa fa-search search__submit-icon" aria-hidden="true"></i>
                </label>
            </form>

            <div class="row block-wrapper" id="surveys">
            ...
            <div class="text-center m-t-20 m-b-10">
                <button id="getMoreBtn" onclick="survey.get.surveys(this)" data-offset="<?= count($surveys); ?>" class="btn btn--lg btn--default btn--round p-r-50 p-l-50">
                    Загрузить ещё
                </button>
            </div>
