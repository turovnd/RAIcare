                ...
                <table width="100%" style="border-spacing: 0;border: 15px solid #008DA7;">
                    ...
                    <tr align="left" style="text-align:left;">
                        <td align="left" valign="top" style="vertical-align:top;text-align:left;background:#ffffff;padding: 15px 35px;">
                            ...
                            <p style="font-size: 1.1em;line-height: 1.5em;"><?= $user->name; ?>, для восстановления вашего пароля на сайте <a href="<?= $_SERVER['HTTP_HOST']; ?>" style="text-decoration: none;color: #008DA7;padding-bottom: 2px;border-bottom: 2px solid #008DA7;"><?= $_SERVER['HTTP_HOST']; ?></a>, Вам надо пройти по следующей ссылке и следовать дальнейшим инструкциям:</p>
