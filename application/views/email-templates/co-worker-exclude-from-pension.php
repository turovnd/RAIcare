...
<html>
    <head>
        <meta charset="utf-8">
        <title>Вас исключили из пансионата на сайте <?= $GLOBALS['SITE_NAME']; ?></title>
                        ...
                        <table width="100%" style="border-spacing: 0;border: 15px solid #008DA7;">
                            ...
                            <tr align="left" style="text-align:left;">
                                <td align="left" valign="top" style="vertical-align:top;text-align:left;background:#ffffff;padding: 35px;">
                                    ...
                                    <p style="margin:12px 0 24px;font-size: 1.15em;">Вас только что исключили из пансионата <?= $penName; ?>. Если это произошло по какой-либо ошибке, пожалуйста, свяжитесь с <b><?= $ownerName; ?></b> для восстановления доступа к пансионату.</p>
                                    <? if ($userDelete) : ?>
