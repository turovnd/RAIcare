                                ...
                                <tbody>
                                    <tr align="left" style="text-align:left;">
                                        <td align="left" valign="top" style="vertical-align:top;text-align:left;background:#ffffff;padding: 35px;">
                                            <p style="margin:0 0 18px;font-weight: bold;font-size: 2em;">Добро пожаловать в <?= $GLOBALS['SITE_NAME']; ?>!</p>
                                            <p style="margin:12px 0 24px;font-size: 1.3em;"><?= $profile->name ?>,  поздравляем вас с успешной регистрацией на сайте <?= strtolower($GLOBALS['SITE_NAME']); ?>.ru!</p>
                                                    ...
                                                    <tr align="left" style="text-align:left;">
                                                        <td align="left" valign="top" style="vertical-align:top;text-align:left;background:#EEEEEE;padding:18px 24px;">
                                                            <p style="margin: 7px 0;font-size: 1.3em;">
                                                                ...
                                                                <b>Ваш логин:</b> <a style="text-decoration: none;color: #008DA7;padding-bottom: 2px;border-bottom: 2px solid #008DA7;"><?= $profile->username; ?></a>
                                                            </p>
                                                            <p style="margin: 7px 0;font-size: 1.3em;">
