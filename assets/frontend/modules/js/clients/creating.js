        ...
        var ajaxData = {
            ...
            success: function (response) {
                ...
                if (parseInt(response.code) === 133 ) {
                    ...
                    var organization = raisoft.draw.node('DIV', 'item clear-fix', {id: 'organization_' + response.id});

                    // organization.innerHTML = '<a href="/organization/' + response.id + '" class="col-xs-3 col-sm-2 col-lg-1 text-center">' +
